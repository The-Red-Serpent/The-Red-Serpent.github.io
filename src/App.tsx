...
const App = () => {
  ...
  const socialLinks = useMemo(() => [
    ...
    { href: 'https://app.hackthebox.com/public/users/2230478?profile-top-tab=machines&ownership-period=1M&profile-bottom-tab=prolabs', icon: <SiHackthebox />,label: 'HackTheBox' },
  ], []);
